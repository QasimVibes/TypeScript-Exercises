...
let messages: string = `Hello ${personName}, would you like to learn some Python today?`;
...
let person: string = "Qasim raZZaq ali";
console.log(person.toLowerCase());
console.log(person.toUpperCase());

let titlecase: string[] = person.split(" ").map((item) => {
...
let names: string[] = ["Ali", "Hamza", "Farhan"];
...
let guestList: string[] = ["Ayesha", "Hina", "Rabia"];
...
let guestLength: number = Math.round(guestList.length / 2);
...
let places: string[] = ["Dubai","United States","Japan","Turkey","Amsterdam",];
...
let programmingLanguages: string[] = ["Java","Ruby","C++","Php","C#","Nodejs"];
...
let changeIndex: string[] = ["Nile","Amazon","Mount Everest","Matterhorn"];
...
const userNames: string[] = ["Rabia","Olivia","Aqsa","Admin","Ava","Qasim"];
...
let current_users: string[] = ["Rabia","Asma","Fatima","Sana","Hina","Ayesha"];

// Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.

let new_users: string[] = ["FATIMA", "Qasim", "Rabia", "Ali", "Rimsha"];
...
let favoritePizza: string[] = ["Neapolitan","New York Style","Margherita",];
...
const make_shirt1 = (size: string = "Large", message: string = "I love TypeScript"): void => {
  console.log(`The T-shirt size is ${size} and it has the message: "${message}"`);
};
make_shirt1();
make_shirt1("Medium");
...
const describe_city = (city: string, country = "Unknown Country"): void => {
...
const make_album = (Artist_Name: string,Album_Title: string,Track?: number): Album => {
...
let magicianNames: string[] = ["Harry Houdini","Lance Burton","David Copperfield","Dynamo",];
const show_magicians = (item: string[]): void => {
  item.forEach((name) => {
    console.log(name);
  });
};
...
const make_sandwich = (items: string[]): void => {
...
const carInformation = (Manufacturer: string, Model: string, ...args: any[]): Object => {
  let Car = {
    Manufacturer,
    Model,
    ...Object.assign({}, ...args),
